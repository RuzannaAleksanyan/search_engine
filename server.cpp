...
//     std::cout << "Received raw message: " << received_message << std::endl;

//     // // Print the received message
//     // std::cout << "Received message from client " << uid << " (" << clients[uid]->name << "): " << received_message << std::endl;
...
//         int receive = recv(client->sockfd, buff_out, sizeof(buff_out), 0);
//         if (receive > 0) {
...
#include "httplib.h" // Assuming this is where the HTTP library is located
